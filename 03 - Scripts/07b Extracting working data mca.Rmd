---
title: "Extracting Working data from data lake: minimum comparable area"
...
SELECT year, sector_id, sum(trade_value*w1) AS imports_mercosur_w1, sum(trade_value*w2) AS imports_mercosur_w2 
FROM TRADE_FLOWS NATURAL JOIN PRODUCT_SECTOR_CROSSWALK
...
save(working.data, file="../02 - Data sets/working_data_mca.Rdata")
```

# Overview for data set

```{r echo=TRUE, message=FALSE, warning=FALSE}
load("../02 - Data sets/working_data_mca.Rdata")
head(working.data)
```
